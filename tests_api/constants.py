...
DELETE_CONTROL_ROD_ALREADY_REMOVED = "Right, .*?, Control rod at .*? already in place!."
PLACE_CONTROL_ROD_MESSAGE = "Right, .*?, Adding control rod at .*?!."
PLACE_CONTROL_ROD_ALREADY_REMOVED_MESSAGE = "Right, .*?, Control rod at .*? already removed!."
